...
wizards_vault_response = {
    'en': '''Your Wizard's Vault {period} objectives: {progress_current} / {progress_complete} {emote_complete}
...
wizards_vault_wvw_objective = {
    'en': '- **{title}** ({objective_reward} {emote_astral_acclaim}): {progress_current} / {progress_complete} {emote_complete}',
    'hu': '- **{title}** ({objective_reward} {emote_astral_acclaim}): {progress_current} / {progress_complete} {emote_complete}'
}

wizards_vault_non_wvw_objective = {
    'en': '- ~~{title}~~: this is not a WvW related objective {emote_vomiting}',
    'hu': '- ~~{title}~~: ez nem WvW-s cél {emote_vomiting}'
}